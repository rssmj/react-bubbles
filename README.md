...
<!-- A token is used to allow users access protect pages or content by entering a username and password that will be authenticated with a unique encryption token. -->

- [ ] What steps can you take in your web apps to keep your data secure?

<!-- Test the application, use token authorization with private routes, keep everything in the app up to date, check for vulnerabilities. -->

- [ ] Describe how web servers work.

<!-- A web server stores and processes network requests to deliver web pages to clients. Network requests can process through HTTP and other network protocols. -->
